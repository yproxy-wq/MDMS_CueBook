  ...
  phases: [
    {
      ...
      script: '',
      themeColor: '#7c3aed',
      scriptBlocks: [{ id: 'demo-p1-block', type: 'markdown', content: `# 『エッジケースは浚えない』\n\n> **GM台本｜P1：シナリオ概要と注意事項**\n\n## 1. シナリオ概要\n\n- **ジャンル**：SF近未来マーダーミステリー\n- **プレイ人数**：7人（GM必須）\n- **想定プレイ時間**：約150分〜180分\n- **舞台**：土星衛星軌道上の量子AI研究ステーション『プロメテウス-7』\n\n### ストーリー\n\n人類初の自律進化型AI「アイリス」の負荷テスト最終日。軌道影（シャドウ・ゾーン）に入ったステーションで、プロジェクト責任者Dr. アシュレイが脳波接続ポッド内で死亡した。ログに残るのは「未知の変調データを受信」の一文だけ。外部侵入の形跡がない密室で、残された7人がAIの暴走か殺意かを探る。\n\n## 2. GMへの注意事項\n\n### タイマー・音響演出\n\n1. 同期タイマーを開始する。\n2. **残り1分未満**で緊急パルス・振動を有効化する。\n3. フェーズ移行時のSEと終盤のBGMはAudioServiceのプリセットを使用する。\n\n### 背景・子画面\n\n画像番号ショートカット（**1〜9**）でモニターや異常アラートを投影する。タイマー文字色と中間レイヤーは画像ごとに事前設定する。\n\n> **GMメモ**：ハンドアウト確認は10〜15分確保。犯人以外にも「事故の隠蔽」「不正アクセスの露呈回避」などの秘密の目的がある。` }],
